...
const registerIntentHandlers = (intentHandlers) => {
  ...
  intentHandlers.SetHome = (intent, session, response) => {
  ...
  intentHandlers.GetTrainsAtHome = (intent, session, response) => {
    storage.loadUserSettings(session, (userSettings) => {
  ...
  intentHandlers.GetTrainsAt = (intent, session, response) => {
