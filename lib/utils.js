...
exports.changeStationName = (stationName, changeType) => {
...
exports.joinListConjunction = (list, separator, conjuction) => {
...
exports.makeGetStationResponse = (trainArrivals, stationName) => {
  let text = '';
  let title = '';
...
exports.makeGetDestinationResponse = (arrivalTimes, destinationStationName) => {
...
exports.replaceAbbreviations = (text, replacements) => {
 ...
 */
exports.findStationByName = (stationName) => _.isNil(stationName)
  ? null
  : _.find(stations, ['Name', this.titleize(stationName)]);
 ...
 */
exports.titleize = (str) => str.replace(/\w+(\W|$)/g, (match) => _.upperFirst(match));
