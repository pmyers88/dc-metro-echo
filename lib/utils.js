...
function changeStationName (stationName, changeType) {
...
function joinListConjunction (list, separator, conjuction) {
...
function makeGetTrainsResponse (trainArrivals, stationName) {
  let text = '';
  let title = '';
...
function makeGetDestinationResponse (arrivalTimes, destinationStationName) {
...
module.exports = {
  changeStationName,
  joinListConjunction,
  makeGetTrainsResponse,
  makeGetDestinationResponse,
